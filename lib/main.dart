                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'TikTok nous distrait et augmente la productivité #Attention à ne pas depasser ',
                        style: TextStyle(
                          color: Colors.white,
                        ),
                      ),
                      ...
                      Row(
                        children: const [
                          ...
                          SizedBox(width: 5),
                          Text(
                            'La vie belle et dur profitons de chaque moment positivement',
                            style: TextStyle(
                              color: Colors.white,
                            ),
                          ),
                        ...
                        children: [
                          Container(
                            ...
                            child: const CircleAvatar(
                              radius: 25,
                              backgroundImage:
                              AssetImage('assets/images/photo_6.png'),
                            ),
                          ),
                          Container(
